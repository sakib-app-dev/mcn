...
***********************************************************/
	if (!isset($_POST['x']) && !isset($_FILES['image']['name']) ){
		//Delete users temp image
			$temppath = '../images/profile_pic/'.$profile_id.'_temp.jpeg';
...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/MCN/images/profile_pic';
	//Set File name	
	...
	//Move the file to correct location
		...
		if (!$move) { 
			...
			$imgSrc= "../images/profile_pic/".$file_name; // the image to display in crop area
...
if (isset($_POST['x'])){
	...
	//the file type posted
		$type = $_POST['type'];	
	//the image src
		$src = '../images/profile_pic/'.$_POST['src'];	
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		//save the new cropped version
			imagejpeg($dst_r, "../images/profile_pic/".$finalname."n.jpeg", 90); 	
		...
		$result_path ="../images/profile_pic/".$finalname."n.jpeg";

		//Insert image into database
		$insert_pic_query = mysqli_query($con, "UPDATE user_info SET profile_pic='$result_path' WHERE username='$userLoggedIn'");
                ...
                <div class="well col-md-offset-2 col-md-8">
                    ...
                    <div class="main_column column">
                        ...
                        <div id="formExample">
                            ...
                            <form action="" method="post"  class="form-group form-horizontalp" enctype="multipart/form-data">
                                <h2 align="center"><b><u>Upload Profile</h2></b></u><br /><br />
                                <input type="file" id="image" name="image" class="form-control" style="width:200px; height:30px; " /><br /><br />
                    ...
                    <?php if ($result_path) {
                        ?>
                    <center> 
                        <h3>Profile Picture has uploaded</h3>
